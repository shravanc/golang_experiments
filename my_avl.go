...
func double(root *Node, dir int) *Node {
    ...
    fmt.Println("Save1: ", save.Data)
    root.Link[opp(dir)].Link[dir] = save.Link[opp(dir)]
    save.Link[opp(dir)] = root.Link[opp(dir)]
    root.Link[opp(dir)] = save

    save = root.Link[opp(dir)]
    fmt.Println("Save2: ",save.Data)
    root.Link[opp(dir)] = save.Link[dir]
    save.Link[dir] = root
    return save
}
...
func insertBalance(root *Node, dir int) *Node {
    n := root.Link[dir]
    bal := 2*dir - 1
    fmt.Println("bal: ", bal, "n.Balance: ", n.Balance)
    if n.Balance == bal {
        root.Balance = 0
        n.Balance = 0
        return single(root, opp(dir))
    }
    fmt.Println("Calling adjustBalance")
    adjustBalance(root, dir, bal)
    fmt.Println("Calling double")
...
func insertR(root *Node, data Key) (*Node, bool) {
    ...
    fmt.Println("1-->data: ",data, "dir: ", dir, "Balance", root.Balance)
    var done bool
    ...
    fmt.Println("2-->data: ",data, "dir: ", dir, "Balance", root.Balance)
    switch root.Balance {
    case 0:
        return root, true
    case 1, -1:
    ...
    fmt.Println("Calling insertBalance", data)
